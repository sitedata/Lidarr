                               ...
                               IHandle<QueueUpdatedEvent>, IHandle<PendingReleasesUpdatedEvent>
    {
        ...
        private QueueStatusResource GetQueueStatus()
        {
            ...
            var resource = new QueueStatusResource
            {
                ...
                Errors = queue.Any(q => q.Artist != null && q.TrackedDownloadStatus.HasValue && q.TrackedDownloadStatus.Value == TrackedDownloadStatus.Error),
                Warnings = queue.Any(q => q.Artist != null && q.TrackedDownloadStatus.HasValue && q.TrackedDownloadStatus.Value == TrackedDownloadStatus.Warning),
                UnknownErrors = queue.Any(q => q.Artist == null && q.TrackedDownloadStatus.HasValue && q.TrackedDownloadStatus.Value == TrackedDownloadStatus.Error),
                UnknownWarnings = queue.Any(q => q.Artist == null && q.TrackedDownloadStatus.HasValue && q.TrackedDownloadStatus.Value == TrackedDownloadStatus.Warning)
            };
